...
//    }];;
    ...
    alert.alertViewTitleColor = [UIColor greenColor];
    alert.alertViewMessageColor = [UIColor orangeColor];
    alert.btnBackgroundColor = [UIColor purpleColor];
    alert.btnTitleColor = [UIColor yellowColor];
    alert.lineColor = [UIColor blackColor];
    [alert addButton:Button_OK withTitle:@"ok" handler:^(JKAlertDialogItem *item) {
        NSLog(@"click %@",item.title);
        
    }];
    [alert addButton:Button_CANCEL withTitle:@"cancle" handler:^(JKAlertDialogItem *item) {
        NSLog(@"click %@",item.title);
